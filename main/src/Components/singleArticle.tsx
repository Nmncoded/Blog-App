...
function SingleArticle(props:comProps):JSX.Element {
    ...
    const fetchData = (url:any,request:any) => {
    ...
    const handleDeleteComment = (id:number | string) => {
        ...
        setComments(comments = comments.filter((c:any) => c.id !== id))
    }
                ...
                <section className='main-single-article'>
                    <article className='container'>
                        ...
                        <div className='taglist'>
                            {
                                article.tagList.map((p:string,index:number) => {
                                    return (
                                        <span key={index} className='div' >{p}</span>
                                    )
                                })
                            }
                        </div>
                                ...
                                <ul className='comments-ul'>
                                    {
                                        ...
                                        (moreComments ? comments : comments.slice(0,3)).map((cmnt:any) => {
                                            return(
